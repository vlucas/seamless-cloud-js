 ...
 */
export async function fetchJSON(fetchFn: any, method: HttpRequestMethod, url: string, body: object, fetchOptions: any = {}) {
  ...
  if (statusCode >= 400) {
    const err = new Error(json.meta?.message || json.error_message || json.message || 'Internal Server Error');
